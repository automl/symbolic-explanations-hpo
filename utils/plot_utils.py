...
def plot_symb2d_subplots(
    ...
    leg = fig.legend(
        handles, labels, loc="lower right", bbox_to_anchor=(0.333, 0.03), fontsize=TITLE_SIZE, framealpha=0.0, handletextpad=0.05
    )
    ...
    cbar.ax.tick_params(labelsize=LABEL_SIZE, which="major")
    plt.tight_layout()
    if plot_dir:
        if filename:
